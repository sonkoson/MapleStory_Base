...
public class AramiaFireWorks {
   ...
   private final void startEvent(final Field map) {
   ...
   private final void spawnMonster(Field map) {
   ...
   public final void giveSuns(MapleCharacter c, int kegs) {
      ...
      Field map = c.getClient().getChannelServer().getMapFactory().getMap(970010000);
      Reactor reactor = map.getReactorByName("mapleTree");
   ...
   private final void startSun(final Field map) {
   ...
   private final void spawnItem(Field map) {
   ...
   public final void giveDecs(MapleCharacter c, int kegs) {
      ...
      Field map = c.getClient().getChannelServer().getMapFactory().getMap(555000000);
      Reactor reactor = map.getReactorByName("XmasTree");
   ...
   private final void startDec(final Field map) {
   ...
   private final void spawnDec(Field map) {
