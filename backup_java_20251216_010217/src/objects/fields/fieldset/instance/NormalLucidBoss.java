...
public class NormalLucidBoss extends FieldSetInstance {
   boolean isPracticeMode = false;
   private Properties Var = new Properties();

   public NormalLucidBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode) {
   ...
   public void userEnter(MapleCharacter user) {
      ...
      if (user.getMap().getId() == 450004150 || user.getMap().getId() == 450004250) {
