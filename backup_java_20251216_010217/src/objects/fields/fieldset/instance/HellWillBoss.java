...
public class HellWillBoss extends FieldSetInstance {
   public HellWillBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader) {
   ...
   public void init(int channel) {
      ...
      this.Var.put("hell", "1");
      this.fieldSeteventTime = 1500000;
      ...
      this.initDeathCount(DBConfig.isGanglim ? 5 : 8);
   ...
   public void userEnter(MapleCharacter user) {
      if (!DBConfig.isGanglim) {
         if (user.getMap().getId() == 450008150) {
