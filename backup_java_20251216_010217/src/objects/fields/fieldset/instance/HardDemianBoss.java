...
public class HardDemianBoss extends FieldSetInstance {
   boolean isPracticeMode = false;
   boolean genesisQuestMode = false;
   private Properties Var = new Properties();

   public HardDemianBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode, boolean genesisQuestMode) {
   ...
   public void init(int channel) {
      ...
      this.initDeathCount(this.genesisQuestMode ? 5 : 10);
