...
public class KaringBoss extends FieldSetInstance {
   boolean isPracticeMode = false;

   public KaringBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode, String difficulty) {
