...
public class PickupReactorRewardItemCheck extends AchievementMissionCheck {
   int itemID;

   public PickupReactorRewardItemCheck(int itemID) {
      this.itemID = itemID;
   }
   ...
   public boolean check(CheckValue checkValue) {
      ...
      ItemCheck iCheck = checkValue.getItem();
      if (iCheck != null) {
