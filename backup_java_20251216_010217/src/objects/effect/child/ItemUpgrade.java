...
public class ItemUpgrade implements Effect {
   public static final int header = EffectHeader.ItemUpgrade.getValue();
   private final int playerID;
   private final int type;
   private final int itemID;

   public ItemUpgrade(int playerID, int type, int itemID) {
