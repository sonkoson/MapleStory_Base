...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        var msg = "#fs11#" + enter;
        msg += "#fc0xFF000000#ดูเหมือนจะมีสัตว์ขี่หลากหลายชนิดเตรียมไว้ให้#b" + enter;
        ...
        switch (sel) {
            ...
            case 2:
                ...
                break;
            case 3:
                var msg = "#fs11#เลือกสัตว์ขี่ที่ต้องการ #fs11##b"
                for (i = 0; i < dskin.length; i++) {
                    if (i % range == 0) {
                        msg += "\r\n"
                    }
