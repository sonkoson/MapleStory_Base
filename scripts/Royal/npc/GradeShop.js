    ...
    if (status == 0) {
        ...
        if (selection == -1) {
            ...
            if (cm.getPlayer().getHgrade() == 14) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item14[selection][0] + "# #z" + item14[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 13) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item13[selection][0] + "# #z" + item13[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 12) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item12[selection][0] + "# #z" + item12[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 11) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item11[selection][0] + "# #z" + item11[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 10) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item10[selection][0] + "# #z" + item10[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 9) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item9[selection][0] + "# #z" + item9[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 8) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item8[selection][0] + "# #z" + item8[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 7) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item7[selection][0] + "# #z" + item7[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 6) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item6[selection][0] + "# #z" + item6[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 5) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item5[selection][0] + "# #z" + item5[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 4) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item4[selection][0] + "# #z" + item4[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 3) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item3[selection][0] + "# #z" + item3[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 2) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item2[selection][0] + "# #z" + item2[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else if (cm.getPlayer().getHgrade() == 1) {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item1[selection][0] + "# #z" + item1[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            } else {
                cm.sendYesNo("#fs11#" + black + "คุณต้องการซื้อระดับ #i " + item[selection][0] + "# #z" + item[selection][0] + "# หรือไม่? \r\n\r\n#r※ ระดับจะเปลี่ยนทันทีเมื่อซื้อ");
            }
        }
    } else if (status == 2) {
        b = selection;
        ...
        if (selection > 1) {
            cm.sendOk("ซื้อได้เพียง 1 ชิ้นเท่านั้น");
            cm.dispose();
        } else {
            if (cm.getPlayer().getHgrade() == 14) {
