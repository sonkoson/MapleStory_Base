...
function action(mode, type, selection)
{
	...
	if (status == 0) {
		var msg = "#fs11##fc0xFF000000#어떤 점프맵으로 이동하실래요?#k\r\n\r\n";
		msg += "#Cgray##fs11#――――――――――――――――――――――――――――――――――――――――#k";
		msg += "#L500# #fMap/MapHelper.img/minimap/party##fc0xFF0066CC# 헤네시스 - 펫 산책로#fc0xFF000000# 사냥터로 이동하겠습니다.#l\r\n";
		//msg += "#L501# #fMap/MapHelper.img/minimap/party##fc0xFF0066CC# 헤네시스 - 펫 산책로#fc0xFF000000# 사냥터로 이동하겠습니다.#l\r\n";
		//msg += "#L502# #fMap/MapHelper.img/minimap/party##fc0xFF0066CC# 헤네시스 - 펫 산책로#fc0xFF000000# 사냥터로 이동하겠습니다.#l\r\n";
		//msg += "#L503# #fMap/MapHelper.img/minimap/party##fc0xFF0066CC# 헤네시스 - 펫 산책로#fc0xFF000000# 사냥터로 이동하겠습니다.#l\r\n";
		msg += "\r\n#Cgray##fs11#――――――――――――――――――――――――――――――――――――――――#k";
      		cm.sendSimple(msg);
	 } else if(status == 1)
	{
