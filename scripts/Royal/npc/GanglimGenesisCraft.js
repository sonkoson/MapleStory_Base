...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        msg += "#fc0xFFB677FF##e[Ganglim] Genesis Weapon Crafting#n  \r\n\r\n"
        ...
        cm.worldGMMessage(21, "[Genesis] " + cm.getPlayer().getName() + " crafted [Genesis Weapon]! Congratulations!");
        cm.sendOk("#fs11##i2439959##z2439959# crafted successfully!");
        cm.dispose();
    }
}
