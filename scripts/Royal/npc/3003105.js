...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "เหล่านักบวชแห่งกาลเวลากำลังสำรวจพื้นที่ Arcane River อยู่ มี Erda Droplet อยู่ไหม? ได้ยินว่ามอนสเตอร์ที่ Lacheln มีอยู่นะ" + enter;
		...
		cm.sendOk("ได้รับ Phantasma Coin แล้ว");
		cm.dispose();
	}
}
