...
function action(mode, type, sel) {
    ...
    */
    if (status == 0) {
        hpmp = 1000 * n;
        var msg = "#fs11##e#fc0xFFFF3300#[Job Change]#n#fc0xFF000000#\r\n\r\nต้องการเปลี่ยนไปเล่นอาชีพอื่นไหม?\r\n#r※ อาชีพ Zero และ Demon Avenger ไม่สามารถเปลี่ยนอาชีพได้#b" + enter + enter;
        ...
        switch (seld) {
            case 1:
                if (status == 1) {
                    ...
                    var msg = "#fs11##fc0xFF000000#กรุณาอ่านข้อควรระวังต่อไปนี้ก่อนเปลี่ยนอาชีพ" + enter;
...
function updateArcSymbolStats(inv, invType, oldType, newType) {
    ...
    for (var i = startSlot; i >= endSlot; i--) {
        ...
        if (isToXenon) {
            ...
            // Subtract 885 from each stat (Total 2655)
