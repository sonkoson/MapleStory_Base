...
]; // Extreme Color-change Hair List
...
var hairList = []; // Final Hair Selection List
var subHairList = []; // Final Hair Selection List (Zero Beta)
var faceList = []; // Final Face Selection List
var subFaceList = []; // Final Face Selection List (Zero Beta)
