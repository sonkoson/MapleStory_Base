...
var Packages.objects.item.MapleInventoryType = Packages.objects.item.MapleInventoryType;
...
var enter = "\r\n";
var ALLOWED_REBIRTH_FIRE_ITEM_ID = [2048717]; //영환불 코드 보시면 많으실꺼에여 거기서 원클릭에 쓰고 싶다는 코드를 입력하시면 되여
