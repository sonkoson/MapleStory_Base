...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getMapId() == 874004002) {
            ...
            talk = "#fs11#คุณพร้อมที่จะเผชิญหน้ากับนักรบแห่งความตาย Akechi Mitsuhide หรือยัง?\r\n\r\n"
            talk += color + "#L0# [Event Boss] - #b[Normal] #rAkechi Mitsuhide #bสมัครเข้าร่วม\r\n";
            talk += color + "#L1# [Event Boss] - #b[Hard] #rAkechi Mitsuhide #bสมัครเข้าร่วม";
            cm.sendSimple(talk);
        }
    } else if (status == 1) {
        if (cm.getPlayer().getMapId() == 874004002) {
