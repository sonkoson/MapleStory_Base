    ...
    if (status == 0) {
        ...
        switch (seld) {
            ...
            case 2:
                ...
                for (i = 0; i < special_needs.length; i++) {
                    ...
                    msg += "#i4001715##z4001715# 30~100개#k" + enter;
                }
        ...
        switch (seld) {
            ...
            case 2:
                ...
                msg += "#L2##i4001715##z4001715# 30 ~ 100개" + enter;
                cm.sendSimple(msg);
                break;
        }
    } else if (status == 3) {
        switch (seld) {
            case 1:
                ...
                for (i = 0; i < reward.length; i++) {
                    if (reward[i][0] == -5)
                        msg += "#i4001715##z4001715# " + reward[i][1] + " ~ " + reward[i][2] + "개" + enter;
                    else
        ...
        switch (seld) {
            case 1:
                ...
                var msg = "교환이 완료되었어.";
                if (reward[a][0] == -5) {
                    msg = "#i4001715##z4001715# #b" + b + "개#k 나왔어!";
                } else
            ...
            case 2:
                ...
                if (seld2 == 1) {
                    ...
                    msg = "#i4001715##z4001715#가 #b" + b + "개#k 나왔어!";
                }
