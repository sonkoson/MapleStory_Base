    ...
    if (status == 1) {
        ...
        switch (seld) {
            ...
            case 3:
                ...
                //selStr += "#L7# #eContact Lens Color#n Change\r\n#l";
                ...
                /*  if (cm.getPlayer().getAndroid() != null) {
                      ...
                      selStr += "#L18# #b#eAndroid#n#b Contact Lens Color#n Change\r\n#l";
                      selStr += "#L20# #b#eAndroid#n#b Skin Color#n Change#l#b\r\n";
                  }*/
                break;
            case 4:
                selStr += "#fnNanumGothic ExtraBold##fs11#We will change your gender, #h0#.\r\n";
                selStr += "#L10# #e" + gColor + "#n Gender Change#l#b\r\n";
                break;
            case 5:
                cm.dispose();
                cm.openShop(1022002);
        ...
        if (SEL_00 == 10) {
            if (cm.getPlayer().getJob() == 10112) {
                cm.sendOkS("Zero class cannot change gender.", 4);
                cm.dispose();
                return;
            }
            cm.sendYesNoS("#e" + gColor + "#n#k Do you want to change your gender? You will no longer be able to wear equipment for your current gender.", 4);
        }

        Beauty = SEL_00 < 2 ? "#eHair#n" : SEL_00 == 2 ? "#eFace#n" : "#eColor#n";
        selStr = "#fnDotum##fc0xFFFFFFFF#I can change your current " + Beauty + " to a completely new style. If you're tired of how you look now, take your time to think about which hair you want to change to.";
