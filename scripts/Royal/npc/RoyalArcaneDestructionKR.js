...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var dialogue = "#fs11#สวัสดีจ้ะ! เธอต้องการจะสร้างอุปกรณ์แห่งความพินาศหรือเปล่าจ๊ะ? รบกวนช่วยเลือกไอเท็มที่เธอต้องการสร้างหน่อยนะ" + lineBreak + lineBreak;
        dialogue += "#fs11##b#e[ArcaneShade แห่งความพินาศ]#k อุปกรณ์นี้จะมีการเพิ่มความสามารถพิเศษจ้ะ\r\n#r[ All Stat + 15% Damage + 15% Boss Damage + 15% อัปเกรดได้ 19 ครั้ง ]#n#k#fs12##b" + lineBreak;
        ...
        if (Packages.objects.utils.Randomizer.rand(1, 100) <= targetItem['successChance']) {
            ...
            cm.worldGMMessage(21, "[Royal Destruction] เธอคนเก่ง " + cm.getPlayer().getName() + " ได้สร้างไอเท็ม [" + cm.getItemName(targetItem['id']) + "] สำเร็จแล้วจ้า!");
        } else {
            cm.sendOk("#fs11#โถ่... เสียใจด้วยนะจ๊ะ เธอสร้างไอเท็มล้มเหลว... ไม่เป็นไรนะ ลองใหม่อีกครั้งนะจ๊ะ");
            cm.worldGMMessage(21, "[Royal Destruction] น่าเสียดายจัง คุณ " + cm.getPlayer().getName() + " สร้างไอเท็ม [" + cm.getItemName(targetItem['id']) + "] ล้มเหลวไปจ้ะ...");
