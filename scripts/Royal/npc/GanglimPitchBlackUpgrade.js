...
var items = [
    {
        'itemid': 1012643, 'qty': 1, 'allstat': 0, 'atk': 0, // Item ID, Qty, All Stat, Attack (Stat applies to equip only)
        'recipes': [[1012632, 1], [4310237, 5000], [4009005, 2000], [4033172, 500], [4001878, 2000], [4031227, 1000], [4001715, 600]], 'price': 0, 'chance': 50, // Recipe, Price, Chance
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        itemsId = 1;
        msg += black + "คุณ #h0#, กรุณาเลือกไอเท็มที่ต้องการสร้าง#fc0xFF990033#\r\n\r\n"
        ...
        if (Packages.objects.utils.Randomizer.rand(1, 100) <= item['chance']) {
            ...
            cm.worldGMMessage(21, "[Chaos Pitch Black] " + cm.getPlayer().getName() + " ได้รับ [" + cm.getItemName(item['itemid']) + "] จากการอัพเกรดไอเท็ม");
        } else {
            cm.sendOk("ล้มเหลว");
