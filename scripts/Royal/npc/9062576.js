        ...
        if (status == 0) {
            ...
            if (result == 2) { // Surrender
                ...
                if (canGain <= 0) {
                    ...
                    v0 += "ฉันจะให้ #e#bNeo Gem 120 อัน#k#n นะ!\r\n\r\n#r(รางวัลจะได้รับเมื่อออกจากแผนที่)#k";
                }
                cm.sayNpc(v0, GameObjectType.Npc, ScriptMessageFlag.NpcReplacedByNpc, ScriptMessageFlag.NoEsc);
                ...
                if (canGain <= 0) {
                    ...
                    v0 += "ฉันจะให้ #e#bNeo Gem 40 อัน#k#n นะ!\r\n\r\n#r(รางวัลจะได้รับเมื่อออกจากแผนที่)#k";
                }
                cm.sayNpc(v0, GameObjectType.Npc, ScriptMessageFlag.NpcReplacedByNpc, ScriptMessageFlag.NoEsc);
            ...
            var result = cm.getPlayer().getOneInfoQuestInteger(1234569, "miniGame3_result");
            var neoGem = cm.getPlayer().getOneInfoQuestInteger(1234569, "miniGame3_result");
            var prevneoGem = cm.getPlayer().getKeyValue(100712, "point");

            if (result == 1) {
                cm.getPlayer().setKeyValue(100712, "point", prevneoGem + 120);
                //cm.getPlayer().gainStackEventGauge(1, 60 * 2, false);
            } else if (result == 4) {
                cm.getPlayer().setKeyValue(100712, "point", prevneoGem + 40);
                //cm.getPlayer().gainStackEventGauge(1, 20 * 2, false);
            } else if (result == 3) {
                cm.getPlayer().setKeyValue(100712, "point", prevneoGem + 60);
                //cm.getPlayer().gainStackEventGauge(1, 30 * 2, false);
            }
