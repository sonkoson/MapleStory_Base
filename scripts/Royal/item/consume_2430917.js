...
function action(M, T, S)
{
	...
	item.setPosition(-21);
	cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-21);
	cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).addFromDB(item);
        cm.getPlayer().send(Packages.network.models.CWvsContext.InventoryPacket.updateInventoryItem(Packages.objects.item.MapleInventoryType.EQUIPPED, item, false, cm.getPlayer()));
		cm.dispose();
	}
...
function addOption(i, isWeapon)
{
	...
	if (i == 1003561) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-1);
		item.setPosition(-1);
	} else if (i == 1052467) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-5);
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-6);
		item.setPosition(-5);
	}  else if (i == 1032148) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-4);
		item.setPosition(-4);
	}  else if (i == 1132161) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-22);
		item.setPosition(-22);
	}  else if (i == 1152099) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-23);
		item.setPosition(-23);
	}  else if (i == 1102467) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-9);
		item.setPosition(-9);
	}  else if (i == 1072672) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-7);
		item.setPosition(-7);
	}  else if (i == 1082438) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-8);
		item.setPosition(-8);
	}  else if (isWeapon) {
		cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).removeSlot(-11);
		item.setPosition(-11);
	}
	item.setFlag((item.getFlag() + Packages.objects.users.enchant.ItemFlag.POSSIBLE_TRADING.getValue()));
	cm.getPlayer().getInventory(Packages.objects.item.MapleInventoryType.EQUIPPED).addFromDB(item);
	cm.getPlayer().send(Packages.network.models.CWvsContext.InventoryPacket.updateInventoryItem(Packages.objects.item.MapleInventoryType.EQUIPPED, item, false, cm.getPlayer()));
}