...
var itemlist = [
{'itemid' : 2439959, 'qty' : 1},
{'itemid' : 2439958, 'qty' : 5},
{'itemid' : 2049376, 'qty' : 10},
{'itemid' : 1122439, 'qty' : 1},
{'itemid' : 1113305, 'qty' : 1},
{'itemid' : 2438145, 'qty' : 6},
{'itemid' : 2439988, 'qty' : 6},
{'itemid' : 2431394, 'qty' : 3},
{'itemid' : 4031227, 'qty' : 10000},
{'itemid' : 4310308, 'qty' : 3000},
{'itemid' : 4310266, 'qty' : 20000},
{'itemid' : 4310237, 'qty' : 30000},
{'itemid' : 4001715, 'qty' : 5000}
]
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        if (!cm.haveItem(2439945, 1)) {
            Packages.scripting.NPCConversationManager.writeLog("TextLog/zenia/[상시패키지]/[핵][NEW]" + 패키지명 + ".log", "\r\n계정 : " + cm.getClient().getAccountName() + " (" + cm.getClient().getAccID() + ")\r\n닉네임 : " + cm.getPlayer().getName() + "\r\n사용한 아이템 : " + 패키지명 + " (" + 패키지코드 + ")" + "\r\n\r\n", true);
            cm.dispose();
            return;
        }
        ...
        var msg = "#fs11##b#e[" + 패키지명 + "] #k#n에서\r\n다음과같은 #b보상#k을 지급 받으시겠습니까?\r\n" + enter + enter;
            msg += "#b#e#i2430017# 강림 포인트 3,000,000 \r\n";
