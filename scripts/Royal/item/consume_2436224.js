...
function action(mode, type, selection) {
	...
	if (Packages.constants.GameConstants.isLuminous(cm.getPlayer().getJob())) {
	...
	} else if (Packages.constants.GameConstants.isXenon(cm.getPlayer().getJob())) {
		txt += "#L3##i" + inz[3] + ":##z" + inz[3] + ":#\r\n";
		txt += "#L4##i" + inz[4] + ":##z" + inz[3] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isDemonAvenger(cm.getPlayer().getJob())) {
		txt += "#L2##i" + inz[2] + ":##z" + inz[2] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isKinesis(cm.getPlayer().getJob())) {
		...
		txt += "#L6##i" + inz[6] + ":##z" + inz[6] + ":#\r\n";
		txt += "#L14##i" + inz[14] + ":##z" + inz[14] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isDemonSlayer(cm.getPlayer().getJob())) {
		txt += "#L7##i" + inz[7] + ":##z" + inz[7] + ":#\r\n";
		txt += "#L8##i" + inz[8] + ":##z" + inz[8] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isMichael(cm.getPlayer().getJob())) {
		txt += "#L6##i" + inz[6] + ":##z" + inz[6] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isKaiser(cm.getPlayer().getJob())) {
		txt += "#L14##i" + inz[14] + ":##z" + inz[14] + ":#\r\n";
	...
	} else if (Packages.constants.GameConstants.isPhantom(cm.getPlayer().getJob())) {
		txt += "#L11##i" + inz[11] + ":##z" + inz[11] + ":#\r\n";
	} else if ((cm.getPlayer().getJob() >= 200 && cm.getPlayer().getJob() <= 232) || (cm.getPlayer().getJob() >= 1200 && cm.getPlayer().getJob() <= 1212) || Packages.constants.GameConstants.isEvan(cm.getPlayer().getJob()) || (cm.getPlayer().getJob() >= 3200 && cm.getPlayer().getJob() <= 3212)) {
	...
	} else if (Packages.constants.GameConstants.isAran(cm.getPlayer().getJob())) {
		txt += "#L18##i" + inz[18] + ":##z" + inz[18] + ":#\r\n";
	...
	} else if ((cm.getPlayer().getJob() >= 510 && cm.getPlayer().getJob() <= 512) || (cm.getPlayer().getJob() >= 1500 && cm.getPlayer().getJob() <= 1512) || Packages.constants.GameConstants.isEunWol(cm.getPlayer().getJob())) {
	...
	} else if (Packages.constants.GameConstants.isMercedes(cm.getPlayer().getJob())) {
		txt += "#L24##i" + inz[24] + ":##z" + inz[24] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isCannon(cm.getPlayer().getJob())) {
		txt += "#L25##i" + inz[25] + ":##z" + inz[25] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isBlaster(cm.getPlayer().getJob())) {
		txt += "#L26##i" + inz[26] + ":##z" + inz[26] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isKadena(cm.getPlayer().getJob())) {
		txt += "#L26##i" + inz[27] + ":##z" + inz[27] + ":#\r\n";
	} else if (Packages.constants.GameConstants.isIllium(cm.getPlayer().getJob())) {
	...
	item = Packages.objects.item.MapleItemInformationProvider.getInstance().getEquipById(inz[select]);
