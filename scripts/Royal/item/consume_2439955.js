...
var itemlist = [
{'itemid' : 2430044, 'qty' : 2},
{'itemid' : 2049376, 'qty' : 2},

{'itemid' : 4031228, 'qty' : 2},
...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        var msg = "#fs11##b#e[" + 패키지명 + "] #k#n에서\r\n다음과같은 #b보상#k을 지급 받으시겠습니까?\r\n" + enter + enter;
            ...
            msg += "#b#e#i4310308# #z4310308# 2000~3500개 \r\n";
        ...
        if (sel == 1) {
            cm.dispose();
            randqty = Packages.objects.utils.Randomizer.rand(2000, 3500);
            cm.gainItem(4310308, randqty);
            for (i = 0; i < itemlist.length; i ++) {
            cm.gainItem(itemlist[i]['itemid'],itemlist[i]['qty']);
            }
            cm.gainItem(패키지코드, -1);
