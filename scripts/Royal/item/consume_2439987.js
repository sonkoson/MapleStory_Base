...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        var msg = "#fs11##b#e[" + 패키지명 + "] #k#n에서\r\n다음과같은 #b보상#k을 지급 받으시겠습니까?\r\n" + enter + enter;
            ...
            msg += "#b#e#i4001715# #z4001715# 2000~6000개 \r\n";
        ...
        if (sel == 1) {
            cm.dispose();
            randqty = Packages.objects.utils.Randomizer.rand(2000, 6000);
