...
function action(mode, type, sel) {
	...
	if (Math.floor(items[seld]['itemid'][seld2] / 10000) == 500)
		Packages.objects.item.MapleInventoryManipulator.addId_Item(cm.getClient(), items[seld]['itemid'][seld2], 1, "", Packages.objects.item.MaplePet.createPet(items[seld]['itemid'][seld2], -1), 30, "", false);
	else
