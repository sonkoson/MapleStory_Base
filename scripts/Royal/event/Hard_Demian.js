...
function spawnMonster(eim, instance, mobid, x, y) {
    ...
    map.broadcastMessage(Packages.network.models.CField.UIPacket.openUI(1115));
}
...
function changedMap(eim, player, mapid) {
    ...
    if (mapid != 350160200 && mapid != 350160240 && mapid != 350160260 && mapid != 350160220 && mapid != 350160280) {
...
function WarptoNextStage(eim) {
    ...
    if (stage == 2) {
        ...
        map.broadcastMessage(CField.BlackLabel("#fn나눔고딕 ExtraBold##fs22##e#r[Hard Demian]#k#fn나눔고딕 ExtraBold# Reward Map", 100, 3000, 3, -100, 50, 1, 4));
        spawnMonster(eim, stage, 8950112, 726, 16); // 보상상자
