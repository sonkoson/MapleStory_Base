...
function WarptoNextStage(eim) {
    ...
    if (stage == 1) {
        map.broadcastMessage(CField.BlackLabel("#fn나눔고딕 ExtraBold##fs22##e#r[Normal Dusk]#k#fn나눔고딕 ExtraBold# Reward Map", 100, 3000, 3, -100, 50, 1, 4));
        spawnMonsterDusk(eim, stage, 8950116, -2672, -489); // Reward Box
