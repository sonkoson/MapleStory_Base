...
function playerEntry(eim, player) {
    ...
    player.changeMap(map, map.getPortal(map.getId() == 450008150 ? Packages.objects.utils.Randomizer.rand(1, 2) : 0));
...
function playAnimation(player, eim) {
    ...
    if (stage == 0) {
        ...
        player.getClient().getSession().writeAndFlush(CField.playSE("Sound/SoundEff.img/esfera/boss/intro1"));
    } else if (stage == 2) {
        ...
        player.getClient().getSession().writeAndFlush(CField.playSE("Sound/SoundEff.img/esfera/boss/intro2"));
    } else if (stage == 4) {
        ...
        player.getClient().getSession().writeAndFlush(CField.playSE("Sound/SoundEff.img/esfera/boss/intro3"));
    }
...
function WarptoNextStage(eim) {
    ...
    while (iter.hasNext()) {
        ...
        pl.changeMap(map.getId(), map.getPortal(map.getId() == 450008150 ? Packages.objects.utils.Randomizer.rand(1, 2) : 0));
        if (stage == 1) {
            ...
            map.broadcastMessage(CField.BlackLabel("#fn나눔고딕 ExtraBold##fs22##e#r[Hard Will]#k#fn나눔고딕 ExtraBold# Reward Map", 100, 3000, 3, -100, 50, 1, 4));
            spawnMonster(eim, stage, 8950115, -71, 247); // Reward Box
