...
function action(mode, type, sel) {
	...
	cm.spineEffect("Effect/Direction20.img/bossBlackMage/fail_spine/black", "animation", "intro", 0, 0, 1, 0);
	cm.effectSound("Sound/Etc.img/BlackMageFailSpine");
	cm.delay(4500);
    } else if (status == 1) {
	cm.environmentChange(31, "intro", 100);
	cm.getOnOffFade(100, "BlackOut", 0);
	cm.getPlayer().setRegisterTransferField(15);
