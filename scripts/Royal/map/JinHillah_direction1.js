...
function action(mode, type, sel) {
	...
	cm.spineEffect("Effect/Direction20.img/effect/BM2_hillahAppear_spine/hillah", "animation", "intro", 0, 0, 1, 0);
	cm.effectSound("Sound/SoundEff.img/BM2/hillahappear");
	cm.delay(13000);
    } else if (status == 1) {
	cm.environmentChange(31, "intro", 100);
	cm.getOnOffFade(100, "BlackOut", 0);
if (cm.getPlayer().getMapId() == 450010900) {
	cm.getPlayer().setRegisterTransferField(cm.getPlayer().getMapId() + 30);
} else {
