...
function action(mode, type, sel) {
    ...
    if (status == 0) {
        ...
        cm.spineEffect("Effect/Direction20.img/bossSlime/1pahse_spine/skeleton", "animation", "intro", 0, 0, 1, 0);
        cm.effectSound("Sound/SoundEff.img/bossSlime/1phase");
        cm.delay(5500);
    } else if (status == 1) {
        ...
        cm.getPlayer().setRegisterTransferField(cm.getPlayer().getMapId() + 10000);
