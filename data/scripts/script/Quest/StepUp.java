...
public class StepUp extends ScriptEngineNPC {
    ...
    public void q100865s() { //스텝업 เริ่ม퀘
        self.say("\r\n안녕!\r\n넌 #b강림 เดือน드#k 도착한 지 얼마 안 된 #b새로운 용사#k구나?", ScriptMessageFlag.NpcReplacedByNpc);
        self.say("\r\n반가워! 내 이름은 #b카산드라#k야!\r\n\r\n메이플 เดือน드 최고의 #b점성술사#k이자 너와 같이 메이플 เดือน드를 새롭게 찾은 용사들을 위한 #bแนะนำ자#k야!", ScriptMessageFlag.NpcReplacedByNpc);
        self.say("\r\n아직 온 지 얼마 안 돼서 이것저것 모르겠는게 많다고?\r\n\r\nวันนี้은 또 어떤 มอนสเตอร์ 사냥해야 할지\r\n육성은 또 어떻게 해야 좋을지?", ScriptMessageFlag.NpcReplacedByNpc);
        ...
        if (1 == self.askYesNo("어때? 메이플 เดือน드의 핵심 요소를 체계적으로 알려줄\r\n#b#e<강림 เดือน드 스텝업>#n#k 이벤트, 너도 เข้าร่วม해 보지 않을래?", ScriptMessageFlag.NpcReplacedByNpc)) {
            ...
            self.say("\r\n이제 특정 เลเวล마다 #b스텝업 ภารกิจ#k ดำเนินการ할 수 있어!\r\n\r\nภารกิจ과 ดำเนินการ สถานะ를 ยืนยัน 싶을 때는 왼쪽 이벤트 알림이에서 #b#e스텝업 아이콘#n#k 클릭 돼!", ScriptMessageFlag.NpcReplacedByNpc);
            //self.say("\r\n#b#e<버닝 เดือน드 스텝업>#n#k\r\n#b#e2021ปี 9เดือน 9วัน(목) 점검 전#n#k까지 ดำเนินการ할 수 있어.\r\n\r\n그 이후에는 ภารกิจ을 달성하거나 รางวัล을 받을 수 없으니\r\nสัปดาห์의하도록 해! 알았지~?", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\nอธิบาย은 여기까지야, 간단하지?\r\n\r\n그럼 #b#e<강림 เดือน드 스텝업>#n#k 신나는 모험되길 바랄게~!\r\n앞으로 이루어질 너의 멋진 성장에 #b치얼스#k~#r♥#k", ScriptMessageFlag.NpcReplacedByNpc);
            getSc().flushSay();
            ...
            self.say("\r\n스스로 개척하길 좋아하는 #b진취적인 스타วัน#k이구나!\r\n\r\n하지만 때로는 다른 사람의 #b노하우#k #bช่วยเหลือ#k 통해\r\n#b더 큰 성장#k 이루어 낼 때도 있어!", ScriptMessageFlag.NpcReplacedByNpc);
            //self.say("\r\n#b<버닝 เดือน드 스텝업>#k #b2021ปี 9เดือน 9วัน(목) 점검 전#k까지\r\nเข้าร่วม할 수 있으니까 혹시 마음이 바뀌면 언제든지 말을 걸어줘~!\r\n\r\n난 언제나  자리에서 널 기다리고 있을게!", ScriptMessageFlag.NpcReplacedByNpc);
        }
    }
    ...
    public void StepUp_1() {
        /*
            ...
            self.say("\r\n저는 #b#h0##k님의 #b스텝업#k ดำเนินการ을 돕게 될\r\n#b<스텝업 골>#k이라고 .\r\n\r\n이름에서 알 수 있듯이 스텝업에서 가장 중요한\r\n#b<GOAL>칸#k 담당 있.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n#b#h0##k님을 #b한 스텝 한 스텝#k 발전하실 수 있도록 돕는 것이 #b저의 ภารกิจ#k.\r\n\r\n#b스텝업#k 기간 동안 잘 부탁드리겠.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n그럼 첫 번째 스텝을 เริ่ม하겠.\r\n\r\n첫 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<เลเวล 범위 มอนสเตอร์>#n#k.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n성장의 พื้นฐาน은 역시 #bมอนสเตอร์ 사냥#k이지요.\r\n\r\n그런데 EXP 높다고 무เงื่อนไข #r높은 เลเวล มอนสเตอร์#k\r\n사냥하는 건 좋은 방법이 아닙니다.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\nเลเวล 차이가 #b10เลเวล 미만#k인 มอนสเตอร์ 사냥\r\nเลเวล차에 따라 #bEXP 보너스#k 얻으실 수 있.\r\n\r\n반대로 #r10เลเวล วินาที과#k인 มอนสเตอร์ 사냥\r\nเลเวล차에 따라 นิดหน่อย씩 #rEXP 패널티#k 받게 .", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n만약 เลเวล 차이가 #r20เลเวล 이상#k이면 사냥하기 몹시 힘들 뿐만 아니라 #r큰 폭의 EXP 패널티#k까지 받게 .\r\n\r\n오히려 #b사냥 효율#k 떨어질 수 있지요.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n따라서 사냥하기 พอดี한 มอนสเตอร์ เลเวล\r\n자신과 เลเวล 차이 #b20เลเวล 이하#k มอนสเตอร์라고 볼 수 있.\r\n\r\n그리고 이런 มอนสเตอร์들을\r\n바로 #b<เลเวล 범위 มอนสเตอร์>#k라고 부릅니다.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n#b[첫 번째 스텝업 ภารกิจ]#k\r\n#b#e<เลเวล 범위 มอนสเตอร์ 300마리 사냥>#n#k.\r\n\r\nเลเวล 차이 20เลเวล 이하의 มอนสเตอร์ 있는\r\nพอดี한 사냥터를 찾아 300마리 사냥해 보시기 바랍니다.", ScriptMessageFlag.NpcReplacedByNpc);
            self.say("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!", ScriptMessageFlag.NpcReplacedByNpc);
         */
        ...
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n저는 #b#h0##k님의 #b스텝업#k ดำเนินการ을 돕게 될\r\n#b<스텝업 골>#k이라고 .\r\n\r\n이름에서 알 수 있듯이 스텝업에서 가장 중요한\r\n#b<GOAL>칸#k 담당 있.");
        questSay.add("\r\n#b#h0##k님을 #b한 스텝 한 스텝#k 발전하실 수 있도록 돕는 것이 #b저의 ภารกิจ#k.\r\n\r\n#b스텝업#k 기간 동안 잘 부탁드리겠.");
        questSay.add("\r\n그럼 첫 번째 스텝을 เริ่ม하겠.\r\n\r\n첫 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<광장 명령어 ใช้>#n#k.");
        questSay.add("\r\nMMORPG พื้นฐาน은 유저들간의 만남이겠죠. 다른 유저들과 쉽게 소통할 수 있는 공간(광장) 쉽게 ย้าย할 수 있는 명령어");
        questSay.add("\r\n#r@광장#k ใช้ 방법을 아시나요? 채팅을통해 #r@광장#k 명령어를 ใช้하게  서버내 특별한 공간! 쉽게 ย้าย할 수 있게 !\r\n광장 명령어를 ใช้해 보시기 바랍니다.");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
    ...
    public void StepUp_4() {
        ...
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n네 번째 스텝업은 룬 ใช้하기.");
        questSay.add("\r\n사냥필드를 돌아다니다 보면 #r#e룬#n#k 발견하실 수 있으실겁니다. 룬을 ใช้하게  룬의 แต่ละ종 เอฟเฟกต์ 및 EXP 2배 Buff 걸리게 ");
        questSay.add("\r\n필드에 소환된 룬을 ใช้하지 않고 วัน정เวลา이 지나게  사냥터에 안좋은 패널티가 부여되게 .");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void StepUp_7() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 วัน곱 번째 스텝을 เริ่ม하겠.\r\n\r\nวัน곱 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<อัพเกรด เสริมแรง>#n#k.");
        questSay.add("\r\nกระเป๋า(I) 버튼을 누르게  #r빨간색 망치버튼#k 발견하실 수 있으실 겁니다.");
        questSay.add("\r\n빨간색 버튼을 누르게  เสริมแรงUI 등장하게 되는데  UI 통해 เสริมแรง를 ดำเนินการ할 수 있.");
        questSay.add("\r\nเสริมแรง에 จำเป็น한 재료는 #bสัปดาห์문의 흔적#k ไอเท็ม เลเวลจำกัด이 높을수록 จำเป็น한 สัปดาห์문의 흔적이 늘어나게  #bสัปดาห์문의 흔적#k 여러 경로(대표적으로 사냥) 통해 ได้รับ 하실 수 있으실 겁니다!");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void StepUp_9() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 아홉 번째 스텝을 เริ่ม하겠.\r\n\r\n아홉 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<스타포스 เสริมแรง>#n#k.");
        questSay.add("\r\nวัน곱 번째 스텝업에서 배운 ไอเท็ม เสริมแรง하기를 기억 하시나요? 스타포스 เสริมแรง 역시 빨간망치버튼(เสริมแรง하기버튼) 통해 ดำเนินการ할 수 있.");
        questSay.add("\r\nสัปดาห์문의 흔적으로 อัพเกรด เสริมแรง가 전부다된 ไอเท็ม เสริมแรง UI 올리게  스타포스 เสริมแรง를 시도할 수 있게되는데 이를 ดำเนินการ하기 위해서는 วัน정량의 Meso จำเป็น.");
        questSay.add("\r\n 역시 อัพเกรด เสริมแรง와 마찬가지로 เลเวลจำกัด이 높은 ไอเท็มวัน수록 더 많은 Meso จำเป็น로 ต้องการ하게  เสริมแรง สถานะ에따라 파괴โอกาส 존재하게 되니 สัปดาห์의하시기 바랍니다!");
    ...
    public void StepUp_10() {
        ...
        questSay.add("\r\nเลเวล 맞는 사냥 필드에서 오랜เวลา 사냥하다보면 วัน반 มอนสเตอร์보다 크기가 더 큰 #r엘리트 มอนสเตอร์#k 등장하게 .");
        questSay.add("\r\n#r엘리트 มอนสเตอร์#k วัน반 มอนสเตอร์보다 HP이 많은대신 다양한 รางวัลไอเท็ม들이 드랍되게 .");
    ...
    public void StepUp_14() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 열네 번째 스텝을 เริ่ม하겠.\r\n\r\n열네 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<이벤트 UIยืนยัน하기>#n#k.");
        questSay.add("\r\n강림 서버는 이벤트(V)키를 통해 ดำเนินการ중인 이벤트 리스트를 ยืนยัน할 수 있던거 알고 계셨나요?");
        questSay.add("\r\n다양한 이벤트 วัน정 및 이벤트로 얻을 수 있는 ไอเท็ม들을 ยืนยัน할 수 있.");
    ...
    public void StepUp_17() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 열วัน곱 번째 스텝을 เริ่ม하겠.\r\n\r\n열วัน곱 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<มอนสเตอร์ 파크>#n#k.");
        questSay.add("\r\nมอนสเตอร์ 파크는 막대한 EXP 및 요วัน별 다양한 รางวัล을 얻을 수 있는 컨텐츠 .");
    ...
    public void StepUp_19() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 열아홉 번째 스텝을 เริ่ม하겠.\r\n\r\n열아홉 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<스타포스 45성>#n#k.");
        questSay.add("\r\n아홉 번째 스텝업에서 배웠던 스타포스 เสริมแรง를 기억하시나요? 다양한 사냥터를 이용하기 위해, 더 강해지기 위해서는 더 높은 스타포스를 ต้องการ .");
    ...
    public void StepUp_20() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n드디어 스무 번째 스텝업 ! 축하드립니다.");
        questSay.add("\r\n그럼 스무 번째 스텝을 เริ่ม하겠.\r\n\r\n스무 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<노멀 บอส>#n#k.");
        questSay.add("\r\n메이플스토리에는 다양한 บอส 존재 . 그 중에서도 대표되는 บอส #b자쿰#k 아시나요?");
        questSay.add("\r\n자쿰은 노말 โหมด, 카오스 โหมด가 존재 이번 스무 번째 스텝업에서 잡아볼 บอส มอนสเตอร์ 노말 자쿰!");
        questSay.add("\r\nบอสUI(T) 단축키를 이용해 บอส เข้า할 수  บอส 클리어 여부또한 ยืนยัน เป็นไปได้.");
    ...
    public void StepUp_21() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 스물한 번째 스텝을 เริ่ม하겠.\r\n\r\n스물한 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<스타포스 80성>#n#k.");
        questSay.add("\r\n스물한 번째 스텝업은 장착 있는 อุปกรณ์의 스타포스 총 수치가 80 넘어보자 .");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        int chuk = 0;
        for (Item item : getPlayer().getInventory(MapleInventoryType.EQUIPPED).list()) {
            Equip equip = (Equip) item;
    ...
    public void StepUp_22() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 스물두 번째 스텝을 เริ่ม하겠.\r\n\r\n스물두 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<เพิ่มตัวเลือก>#n#k.");
        questSay.add("\r\nMMORPG 강해지는 방법 중 하나 바로 더 강한 ไอเท็ม 장착이지요!");
        questSay.add("\r\n더 강한 ไอเท็ม 장착하는 방법중 하나 자신에게 더 좋은 เพิ่มตัวเลือก 있는 ไอเท็ม 장착하기!");
        questSay.add("\r\nเพิ่มตัวเลือก 강력한 환생의 불꽃, 영원한 환생의 불꽃, 검은 환생의 불꽃 ไอเท็ม 통해 รีเซ็ต เป็นไปได้.");
        questSay.add("\r\n스물두 번째 스텝업은 환생의 불꽃 ไอเท็ม 통해 เพิ่มตัวเลือก รีเซ็ต하기 .");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void StepUp_23() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 스물세 번째 스텝을 เริ่ม하겠.\r\n\r\n스물세 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<어빌리티>#n#k.");
        questSay.add("\r\nตัวละคร 강하게 만들기 위해서는 ตัวละคร 내면에 숨겨진 힘 어빌리티를 좋게 만드는 방법도 있.");
        questSay.add("\r\n최วินาที에 어빌리티는 왼쪽 전구 어빌리티 เควส 통해 부여받을 수 있게");
        questSay.add("\r\n어빌리티의 รีเซ็ต ระดับ별 จำเป็น 명성치를 이용해 Stat창(S) 및 서큘레이터 ไอเท็ม 통해 รีเซ็ต 할 수 있.");
        questSay.add("\r\n스물세 번째 스텝업은 어빌리티 รีเซ็ต하기 .");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void StepUp_24() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 스물네 번째 스텝을 เริ่ม하겠.\r\n\r\n스물네 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<무릉도장>#n#k.");
        questSay.add("\r\n무릉도장은 แต่ละ 층에 배치있는 บอส들을 한층한층 격파해나가며 더 위로 올라가야하는 컨텐츠!");
        questSay.add("\r\n물론 위로 올라갈수록 더 강한 บอส들이 존재 더 높은층을 올라갈수록 สัปดาห์마다 ดำเนินการ되는 무릉도장 정산을 통해 다양한 ไอเท็ม ได้รับ할 수 있.");
        questSay.add("\r\n무릉도장을 많은 이용 바라며 이번 스텝업은 클리어 เงื่อนไข없이 ภารกิจ เสร็จสมบูรณ์버튼을 누르시면 .");
        questSay.add("\r\n아! 참고로 무릉도장 역시 มอนสเตอร์파크와 같이 컨텐츠 ระบบ을 이용해 이용하실 수 있. 감사.");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void StepUp_27() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 스물วัน곱 번째 스텝을 เริ่ม하겠.\r\n\r\n스물วัน곱 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<소멸의 여로>#n#k.");
        questSay.add("\r\n소멸의 여로 이후 사냥터부터는 아케인 포스를 ต้องการ하게 . 물론  아케인 포스는 มอนสเตอร์ 강해지면 강해질수록 더 높은 아케인 포스를 ต้องการ하게 ");
        questSay.add("\r\n아케인 포스를 높이는 방법으로는 วันวัน เควส, แต่ละ종 이벤트, วันวัน 마을별 컨텐츠, 슈피겔만의 퀵패스를 이용해 아케인 심볼을 ได้รับ해 아케인 포스를 늘릴 수 있.");
        questSay.add("\r\n스물วัน곱 번째 스텝업은 슈피겔만(아케인리버 퀵패스) 엔피시에게 말을 걸어보자 .");
        questSay.add("\r\n슈피겔만(아케인리버 퀵패스)엔피시는 แต่ละ종 마을(이름 없는 마을, 츄츄 아วัน랜드 등) ตำแหน่ง 있.");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void StepUp_28() {
        ...
        List<String> questSay = new ArrayList<>();
        questSay.add("\r\n안녕하십니까, #b#h0##k.\r\n#b<스텝업>#k 오신 걸 환영.");
        questSay.add("\r\n그럼 스물여덟 번째 스텝을 เริ่ม하겠.\r\n\r\n스물여덟 번째 스텝에서 알아볼 เนื้อหา은\r\n#b#e<스타포스 120성>#n#k.");
        questSay.add("\r\n스물여덟 번째 스텝업은 장착 있는 อุปกรณ์의 스타포스 총 수치가 120 넘어보자 .");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        int chuk = 0;
        for (Item item : getPlayer().getInventory(MapleInventoryType.EQUIPPED).list()) {
            Equip equip = (Equip) item;
    ...
    public void StepUp_29() {
        ...
        questSay.add("\r\n스텝업 기간동안 엘리트 มอนสเตอร์ 사냥하랴 룬도 ใช้하랴 어빌리티도 รีเซ็ต하랴 고생 많으셨.");
        questSay.add("\r\n그럼 ครั้งสุดท้าย 스텝업을 เริ่ม하겠.");
        questSay.add("\r\nครั้งสุดท้าย 스텝업은 <아케인포스> 스텝업! .");
        questSay.add("\r\n220เลเวล 달성한 용사님 정도면 วันวัน เควส 및 แต่ละ종 이벤트로 아케인포스를 가득 채웠겠지요!??");
        questSay.add("\r\nครั้งสุดท้าย 스텝업의 เนื้อหา은 아케인포스 3000채우기 .");
        questSay.add("\r\n220인데 3000 너무 많은거 아.니.냐.구.요?");
        questSay.add("\r\n저는 모르겠.");
        questSay.add("\r\n\r\n그럼 ภารกิจ เสร็จสมบูรณ์ 후 다시 뵙도록 하겠.\r\n건투를 빕니다!");
        questSay.add("\r\n라고 할뻔! 지금까진 장난이였구 스텝업 เควส 하느라 고생 많으셨. 엔피시 สนทนา가 สิ้นสุด된뒤에 ภารกิจ เสร็จสมบูรณ์ 누르시면 . 그럼 수고많으셨. 감사.");
        check_step_up(level, questID, questSay, reward, rewardQTY, rewardString, mission);
    }
    ...
    public void check_step_up(int sLevel, int questID, List<String> questSay, int reward, int rewardqty, String rewardString, String mission) {
        ...
        if (getPlayer().getQuestStatus(questID) < 1) { //เควส 안받아져있는 สถานะ
            ...
            if (getPlayer().getOneInfoQuestInteger(questID, "value") == 1 && (getPlayer().isQuestStarted(questID)/* || ((questID - 501525 + 1) == getPlayer().getOneInfoQuestInteger(501524, "step"))*/)) {
                if (1 == self.askYesNo("\r\n#b[" + sLevel + "เลเวล 스텝업 ภารกิจ]#k 달성을 축하드립니다!\r\n지금 바로 #bภารกิจ รางวัล#k 받으시겠습니까?\r\n\r\n\r\n#fUI/UIWindow2.img/Quest/quest_info/summary_icon/reward#\r\n#b#i" + reward + ":# #t" + reward + ":# " + rewardqty + "개#k\r\n", ScriptMessageFlag.NpcReplacedByNpc)) {
                    ...
                    if (mif.getItemInformation(reward) != null) {
                        ...
                        if (target.exchange(reward, rewardqty) > 0) {
                            ...
                            self.sayOk("กระเป๋า 공간이 ไม่พอ. 공간을 넉넉히 비운뒤 다시 시도โปรด!", ScriptMessageFlag.NpcReplacedByNpc);
                        }
                    } else {
                ...
                if (getPlayer().getQuestStatus(questID) == 2) {
                    self.say("이미 깬 스텝업 ภารกิจ이거나 จำเป็น한 เลเวล 달성하지 못แล้ว.");
                } else {
