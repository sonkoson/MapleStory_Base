...
public class HasteEvent extends ScriptEngineNPC {
    ...
    public void q16401s() {
        if (getPlayer().getQuestStatus(QuestExConstants.HasteEventInit.getQuestID()) < 1) {
            ...
            self.say("#b#e<헤이스트>#n#k #b2021ปี 11เดือน 4วัน 오전 0시#k부터 #b12เดือน 5วัน 오후 11시 59นาที#k까지 #b여러 가지 변화#k 생겨나 말 그대로 #b사냥을 가속#k시킬 수 있는 이벤트야!");
            self.say("어떤 변화가 생기냐면~!");
            self.say("#b- #e엘리트 มอนสเตอร์#n #e더#n 자สัปดาห์ 나와!\\r\\n- #e룬#n #e더#n 자สัปดาห์ 나오고 #e더#n 자สัปดาห์ 쓸 수 있어!\\r\\n- #e룬#n EXP เอฟเฟกต์가 두 배로 #e더#n 강력해져!\\r\\n- #e돌발ภารกิจ#n 하루에 두 배로 #e더#n 클리어할 수 있어!\\r\\n- #e폴로 & 프리토#n #e더#n 자สัปดาห์ 나와!\\r\\n- #e불꽃늑대#n EXP 1.5배로 #e더#n 강력해져!");
            self.say("어때? 듣기만 해도 사냥이 팍팍 가속될 것 같지 않아?\\r\\n\\r\\n이뿐만이 아니야!\\r\\n이벤트 기간 동안 #b#e6가지 วันวัน ภารกิจ#n#k 수행할 수 ,\\r\\nภารกิจ을 달성할 때 마다 #b#e<헤이스트 상자>#n#k 받을 수 있어!");
            self.say("6개의 #b<헤이스트 상자>#k에서는 푸짐한 #bรางวัล#k #b헤이스트 부스터#k 얻을 수 있으니까 ทุกวันทุกวัน 놓치지 말라구~!\\r\\n#b헤이스트 부스터#k ใช้ 100วินาที동안 #bมอนสเตอร์#k #bเพิ่ม#k #b소환#k되니 사냥도 성장도 더 빠르게 가속시킬 수 있지!");
            self.say("하나 더!\\r\\n\\r\\n하루에 #e#b6가지 <헤이스트 วันวัน ภารกิจ>#n#k 전부 달성...\\r\\n흐흐... 그건 네가 직접 ยืนยัน해 봐!");
            ...
            getPlayer().updateInfoQuest(QuestExConstants.HasteEvent.getQuestID(),
                    "M1=0;M2=0;M3=0;M4=0;M5=0;M6=0;date=21/11/03;booster=0;openBox=0;unlockBox=0;str=1단계 상자 도전 중! วันวัน ภารกิจ 1개를 เสร็จสมบูรณ์하세요!");
        } else {
