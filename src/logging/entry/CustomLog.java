...
public class CustomLog extends LoggingEntry {
   int type;

   public CustomLog(String name, String accountName, int playerID, int accountID, int type, StringBuilder log) {
      super(LoggingType.CustomLog, accountName, name, playerID, accountID, log, System.currentTimeMillis());
      this.setType(type);
   }
