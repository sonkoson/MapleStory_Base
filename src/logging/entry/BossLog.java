...
public class BossLog extends LoggingEntry {
   private int type;

   public BossLog(MapleCharacter player, int type, StringBuilder log) {
      super(LoggingType.BossLog, player.getClient().getAccountName(), player.getName(), player.getId(), player.getAccountID(), log, System.currentTimeMillis());
      this.setType(type);
   }
