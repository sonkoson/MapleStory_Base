...
public class CashSmellEffect implements Effect {
   public static final int header = EffectHeader.CashSmellEffect.getValue();
   private final int playerID;
   private final int itemID;

   public CashSmellEffect(int playerID, int itemID) {
