...
public class RewardItem implements Effect {
   public static final int header = EffectHeader.RewardItemAnimation.getValue();
   private final int playerID;
   private final int itemID;
   private final String data;

   public RewardItem(int playerID, int itemID, String data) {
   ...
   public void encode(PacketEncoder packet) {
      ...
      packet.write(this.data.length() > 0);
