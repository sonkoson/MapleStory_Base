...
public class WZEffectBased implements Effect {
   public static final int header = EffectHeader.WZEffectBased.getValue();
   private final int playerID;
   private final String data;

   public WZEffectBased(int playerID, String data) {
