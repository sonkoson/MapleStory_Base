...
public class ZeniaAuctionItem {
   ...
   private Item item;
   private ZeniaAuctionHistory history;
   ...
   public ZeniaAuctionHistory getHistory() {
      return this.history;
   }

   public void setHistory(ZeniaAuctionHistory history) {
