...
public class Field_Papulatus extends Field {
   ...
   public void endPapulatusCrack() {
      if (this.hpWheel != null) {
         ...
         MapleMonster boss = this.getBoss();
         if (boss != null) {
            this.broadcastMessage(CField.startMapEffect("Papulatus attempts to heal HP through dimensional shift.", 5120177, true, 4));
            long hp = boss.getHp();
   ...
   public void startPapulatusCrack(int castingTime, int hour, int minute) {
      if (this.hpWheel == null) {
         ...
         this.broadcastMessage(CField.startMapEffect("You must seal the dimensional rift so Papulatus cannot time travel.", 5120177, true, 4));
   ...
   public void tryRemoveWheel() {
      if (this.hpWheel != null) {
         ...
         if (!part.removed) {
            ...
            this.broadcastMessage(CField.startMapEffect("Sealed the dimensional rift.", 5120177, true, 4));
   ...
   public void addWheelTime(int hour, int minute) {
      if (this.hpWheel != null) {
         ...
         this.broadcastMessage(CField.startMapEffect("Papulatus's clock is moving. Seal time through the dimensional portal.", 5120177, true, 4));
      }
   }
