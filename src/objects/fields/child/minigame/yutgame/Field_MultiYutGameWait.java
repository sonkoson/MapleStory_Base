...
public class Field_MultiYutGameWait extends Field {
   public Field_MultiYutGameWait(int mapid, int channel, int returnMapId, float monsterRate) {
   ...
   public void onEnter(MapleCharacter player) {
      ...
      player.setNextTransferMinigameField(993189900);
