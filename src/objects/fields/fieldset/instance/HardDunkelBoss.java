...
public class HardDunkelBoss extends FieldSetInstance {
   boolean isPracticeMode = false;
   private Properties Var = new Properties();

   public HardDunkelBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode) {
