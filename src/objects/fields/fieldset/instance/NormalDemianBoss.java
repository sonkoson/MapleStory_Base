...
public class NormalDemianBoss extends FieldSetInstance {
   boolean isPracticeMode = false;
   private Properties Var = new Properties();

   public NormalDemianBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode) {
   ...
   public void userEnter(MapleCharacter user) {
      ...
      if (user.getMap().getId() == 350160200 || user.getMap().getId() == 350160240) {
