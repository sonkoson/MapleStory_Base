...
public class HardWillBoss extends FieldSetInstance {
   boolean isPracticeMode = false;
   boolean genesisQuestMode = false;
   private Properties Var = new Properties();

   public HardWillBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode, boolean genesisQuestMode) {
