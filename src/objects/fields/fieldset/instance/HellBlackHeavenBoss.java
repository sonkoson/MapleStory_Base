...
public class HellBlackHeavenBoss extends FieldSetInstance {
   boolean isPracticeMode = false;
   private Properties Var = new Properties();

   public HellBlackHeavenBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode) {
   ...
   public void init(int channel) {
      ...
      this.initDeathCount(DBConfig.isGanglim ? 3 : 5);
