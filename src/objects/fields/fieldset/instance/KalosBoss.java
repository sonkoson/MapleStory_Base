...
public class KalosBoss extends FieldSetInstance {
   boolean isPracticeMode = false;

   public KalosBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode, String difficulty) {
   ...
   public void init(int channel) {
      ...
      this.fieldSeteventTime = 1801000;
