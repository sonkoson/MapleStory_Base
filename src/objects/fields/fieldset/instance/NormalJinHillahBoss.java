...
public class NormalJinHillahBoss extends FieldSetInstance {
   public boolean isPracticeMode = false;
   private Properties Var = new Properties();

   public NormalJinHillahBoss(FieldSet fs, FieldSetInstanceMap fsim, MapleCharacter leader, boolean isPracticeMode) {
