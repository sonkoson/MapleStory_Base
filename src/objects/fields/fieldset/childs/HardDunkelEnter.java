...
public class HardDunkelEnter extends FieldSet {
   public HardDunkelEnter(int channel) {
      super("HardDunkelEnter", channel);
         ...
         if (enterInteger > 6 && nCharacter != null) {
            ...
            for (FieldSetInstanceMap fsim : this.instanceMaps) {
               if (fsim.instances.get(0) == enterInteger) {
                  FieldSetInstance fsi = new HardDunkelBoss(this, fsim, nCharacter, isPracticeMode);
