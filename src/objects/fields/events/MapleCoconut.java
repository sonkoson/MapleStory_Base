...
public class MapleCoconut extends MapleEvent {
   ...
   public void onMapLoad(MapleCharacter chr) {
      super.onMapLoad(chr);
      chr.getClient().getSession().writeAndFlush(CField.coconutScore(this.getCoconutScore()));
   }

   public MapleCoconut.MapleCoconuts getCoconut(int id) {
      return id >= this.coconuts.size() ? null : this.coconuts.get(id);
   }
   ...
   public void setHittable(boolean hittable) {
      for (MapleCoconut.MapleCoconuts nut : this.coconuts) {
   ...
   public void startEvent() {
      ...
      this.getMap(0).broadcastMessage(CField.hitCoconut(true, 0, 0));
               ...
               public void run() {
                  for (MapleCharacter chr : MapleCoconut.this.getMap(0).getCharactersThreadsafe()) {
                     if (MapleCoconut.this.getMapleScore() > MapleCoconut.this.getStoryScore() && chr.getTeam() == 0
                        || MapleCoconut.this.getStoryScore() > MapleCoconut.this.getMapleScore() && chr.getTeam() == 1) {
