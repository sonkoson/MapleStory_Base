...
public enum ImprintedStoneOption {
   ...
   MadR(3, "พลังเวท %s%d%s%s", true, SecondaryStatFlag.indieMadR),
   CriticalDamageR(4, "คริติคอลดาเมจ %s%d%s%s", true, SecondaryStatFlag.indieCD),
   BossDamageR(5, "ดาเมจทำต่อบอส %s%d%s%s", true, SecondaryStatFlag.indieBDR),
   IgnoreMobPdpR(6, "เพิกเฉยต่อพลังป้องกัน %s%d%s", false, SecondaryStatFlag.indieIgnoreMobPdpR),
   CriticalRate(7, "อัตราคริติคอล %s%d%s%s", false, SecondaryStatFlag.indieCR),
   PMDR(8, "ไฟนอลดาเมจ %s%d%s%s", true, SecondaryStatFlag.indiePMDR),
