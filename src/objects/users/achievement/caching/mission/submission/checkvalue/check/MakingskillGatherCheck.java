...
public class MakingskillGatherCheck extends AchievementMissionCheck {
   boolean success;
   int skillID;

   public MakingskillGatherCheck(boolean success, int skillID) {
   ...
   public void checkMission(MapleCharacter player, AchievementSubMissionType type, long delta) {
      int[] ids = new int[]{183, 184, 185, 186, 187, 188, 189, 190};
