...
public class SuddenMissionRewardCheck extends AchievementMissionCheck {
   int meso;

   public SuddenMissionRewardCheck(int meso) {
      this.meso = meso;
   }
