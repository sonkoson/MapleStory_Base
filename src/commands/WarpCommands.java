...
public class WarpCommands implements Command {
   ...
   public void execute(MapleClient c, String[] splitted) throws Exception, IllegalCommandSyntaxException {
      ...
      if (splitted[0].equals("!warp")) {
         ...
         if (victim != null) {
            ...
            victim.dropMessage(5, "คุณถูกเรียกตัวโดGM");
            if (victim.getMapId() != c.getPlayer().getMapId()) {
   ...
   public CommandDefinition[] getDefinition() {
      return new CommandDefinition[] {
            new CommandDefinition("!warp", "<ชื่อัวละคร> (<รหัสแผนที่>)",
                  "วาร์ปตัวเองไปหาผู้เล่น หรือวาร์ปผู้เล่นไปยังแผนที่", 2),
            new CommandDefinition("!warphere", "<ชื่อัวละคร>", "เรียกผู้เล่นมาหาคุณ", 2),
